...
4. Write the Markdown before rendering. Use prose for reasoning, tables for repeated fields or comparisons, code blocks for genuinely machine-readable material, and workflows for branching or ordered decisions.
...
8. Validate the Markdown, standardize citations, and then render the DOCX. Report any unsupported feature or rendering fallback instead of silently losing content.
