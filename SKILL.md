...
4. Write the Markdown before rendering. Use prose for reasoning, tables for repeated fields or comparisons, code blocks for genuinely machine-readable material, and workflows for branching or ordered decisions. Put each table caption once, immediately above its table; never repeat it below.
